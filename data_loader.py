...
def load_data(MR_Raw,RO_factor):
    ...
    RO=kdata.shape[2]/RO_factor #readout for center out allows you to choose your spatial resolution, currently I just set it to full spatial resolution
    kdata=kdata[:,:,:RO]
    coords=coords[:,:RO]
    dcfs=dcfs[:,:RO]
